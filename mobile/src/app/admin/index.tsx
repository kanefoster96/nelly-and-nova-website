 ...
 *
 * A collection-route-planner + pickup-notification version of this screen
 * was built and then deliberately pulled back out (along with the walk
 * tracker) to keep the customer app simple for its first working version —
 * see git history on this file / lib/collections.ts if picking it back up.
 */
